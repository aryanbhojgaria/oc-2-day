...
const roles: RoleConfig[] = [
  {
    ...
    credentials: { email: "admin@octocampus.edu", password: "admin@2026" },
  ...
  },
  {
    ...
    credentials: { email: "teacher@octocampus.edu", password: "teach@2026" },
  ...
  },
  {
    ...
    credentials: { email: "student@octocampus.edu", password: "stud@2026" },
  ...
  },
  {
    ...
    credentials: { email: "parent@octocampus.edu", password: "parent@2026" },
  ...
  },
  {
    ...
    credentials: { email: "club@octocampus.edu", password: "club@2026" },
  ...
  return (
    ...
    >
      ...
      <motion.div className="text-center">
        ...
        >
          Octo<span className="text-primary">Campus</span>
        </motion.h1>
        <motion.p
    ...
    <div className="relative min-h-screen bg-background bg-grid overflow-x-hidden">
      ...
      >
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold tracking-tight text-foreground">OctoCampus</span>
        </Link>
      ...
      >
        ...
        <h1 className="mt-2 text-balance text-3xl font-bold text-foreground lg:text-4xl">
          Sign In to <span className="text-primary">OctoCampus</span>
        </h1>
      ...
      >
        <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
          <p className="text-xs text-muted-foreground">OctoCampus 2026. Built for hackathon demonstration.</p>
