...
const defaultCredentials: Record<string, { email: string; password: string }> = {
  admin: { email: "admin@octocampus.edu", password: "admin@2026" },
  teacher: { email: "teacher@octocampus.edu", password: "teach@2026" },
  student: { email: "student@octocampus.edu", password: "stud@2026" },
  parent: { email: "parent@octocampus.edu", password: "parent@2026" },
  club: { email: "club@octocampus.edu", password: "club@2026" },
}
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder={`${role}@octocampus.edu`}
