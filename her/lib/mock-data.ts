...
export const timetable = [
  { day: "Monday", slots: ["Data Structures", "Operating Systems", "Break", "DBMS Lab", "Elective"] },
  { day: "Tuesday", slots: ["Mathematics III", "Computer Networks", "Break", "OS Lab", "Library"] },
  { day: "Wednesday", slots: ["DBMS", "Data Structures", "Break", "Elective", "Sports"] },
  { day: "Thursday", slots: ["Computer Networks", "Mathematics III", "Break", "CN Lab", "Seminar"] },
  { day: "Friday", slots: ["Data Structures", "DBMS", "Break", "Project Work", "Mentoring"] },
]
